...
<head>
    ...
    <meta charset="UTF-8">
    <title>Contato Banhatos's</title>
...
<div class="flex-container flx_cont">
  ...
  <div class="card cart_1" class="" style="width: 18rem;">
    <div class="card-body">
      ...
      <p class="card-text cart_txt">Entre em contato para futuras parcerias ou para falar diretamente com o setor administrativo. <br><b><span>(Não realizamos pedidos pelo E-mail)</span></b></p>
      <a href="https://www.google.com/intl/pt-BR/gmail/about/" target="_blank" class="fa fa-google cart_link1"></a>
    </div>
  </div>
