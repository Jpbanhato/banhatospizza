...
<div class="container flexbox_cont">
    ...
    <div class="offcanvas offcanvas-start inicio-sidebar" tabindex="-1" id="offcanvasExample"
        ...
        <div class="offcanvas-header titulo-topo">
            ...
            <button type="button" class="btn-close text-reset botao-fechar" data-bs-dismiss="offcanvas"
        ...
        <div class="offcanvas-body corpo-sidebar">
            ...
            <ul class="listas">
                ...
                <li> <i class="bi bi-list-nested"></i> <a class="categorias-1" href="/admin/categorias"> Categorias </a>
                </li>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                Após clicar no botão "Sim", você será direcionado para a área de login. Deseja
                                prosseguir com essa decisão ?
                            </div>
