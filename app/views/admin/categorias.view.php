    ...
    <div class="container-fluid">
        <div class="row flex-nowrap">
            ...
            <div class="container">
                ...
                <nav class="navbar navbar-light bg-light nav-search">
                    <div class="container-fluid bottom-add d-flex">
                        ...
                        <button type="button" class="btn btn-success btn-add" data-bs-toggle="modal"
                            data-bs-target="#AddCategory">Adicionar</button>
                    </div>
                </nav>
                                ...
                                <td class="d-flex justify-content-end colum-bottons-table">
                                    <div class="d-grid gap-2 d-md-block">
                                        ...
                                        <button type="button" class="btn btn-primary bottom-options"
                                            data-bs-toggle="modal" data-bs-target="#EditCategory-<?= $categoria->id ?>">
                                            &#128393;
                                        </button>

                                        <!-- Button modal visualizar Category -->
                                        <button type="button" class="btn btn-secondary bottom-options"
                                            data-bs-toggle="modal" data-bs-target="#ViewCategory-<?= $categoria->id ?>">
                                            &#8981;
                                        </button>
                                        ...
                                        <button type="button" class="btn btn-danger bottom-options"
                                            ...
                                            data-bs-target="#DeleteCategory-<?= $categoria->id ?>">
                                            &#9852;
                                        </button>
                                    </div>
                                </td>
                ...
                <?php foreach ($categorias as $categoria) : ?>
                <div class="modal fade" id="EditCategory-<?= $categoria->id ?>" data-bs-backdrop="static"
                            ...
                            <div class="modal-body">
                                ...
                                <form action="categorias/update" method="post" class="row g-3">
                                    <div class="col-md-8">
                                        ...
                                        <input type="text" class="form-control" name="nome" id="inputNameEditCategory"
                ...
                <?php foreach ($categorias as $categoria) : ?>
                <div class="modal fade" id="ViewCategory-<?= $categoria->id ?>" data-bs-backdrop="static"
                    data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-xl">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <fieldset disabled>
                                    <form class="row g-3">
                                        <div class="col-md-8">
                                            ...
                                            <input type="text" class="form-control" id="ViewNameCategory"
                                                placeholder="<?= $categoria->nome ?>" readonly>
                                        </div>
                                    </form>
                                </fieldset>
                            </div>
                ...
                <?php foreach ($categorias as $categoria) : ?>
                <div class="modal fade" id="DeleteCategory-<?= $categoria->id ?>" data-bs-backdrop="static"
                    data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
