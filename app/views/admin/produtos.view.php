...
<body>
    <div class="container-fluid">
        <div class="row flex-nowrap">
            ...
            <div class="container">
                ...
                <nav class="navbar navbar-light bg-light nav-search">
                    <div class="container-fluid bottom-add d-flex">
                        <form class="d-flex justify-content-end bar-search" action="/admin/produtos/search"
                            method="get">
                                ...
                                <form action="/admin/produtos/create" method="POST" class="row g-3">
                                    ...
                                    <div class="col-12">
                                        <label for="inputDescriptionAddProdut" class="form-label">Descrição do
                                            Produto</label>
                                        <textarea class="form-control" name="descricao" id="inputDescriptionAddProdut"
                                            rows="3" placeholder="Ingredientes e porções"></textarea>
                                    </div>
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-12">
                                        <label for="inputDescriptionAddProdut" class="form-label">Informações
                                            Úteis</label>
                                        <textarea class="form-control" name="informacoesUteis"
          ...
          ?>
                <div class="modal fade" id="EditarProd-<?= $row->id ?>" data-bs-backdrop="static"
                                    ...
                                    <div class="col-12">
                                        <div class="col-12">
                                            ...
                                            <textarea class="form-control" name="descricao"
                                                id="inputDescriptionEditProdut" rows="3"
                                                placeholder="Ingredientes e porções"><?= $row->descricao ?></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
      ...
      ?>
                ...
                <div class="modal fade" id="VisualizarProd-<?= $row->id ?>" data-bs-backdrop="static"
                    data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-xl">
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <div class="modal-body">
                                <fieldset disabled>
                                    <form class="row g-3">
                                        ...
                                        <div class="col-12">
                                            <label for="ViewDescriptionProduct" class="form-label">Descrição do
                                                Produto</label>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <select id="ViewCategoryProduct" class="form-select">
                                                ...
                                                <option value="<?= $row->idCategoria ?> " selected>
                                                    <?=  $row->nomeCategoria ?></option>
      ...
      ?>
                ...
                <div class="modal fade" id="ExcluiProd-<?= $row->id ?>" data-bs-backdrop="static"
                    data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
